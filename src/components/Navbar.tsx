...
const session = await getServerSession(authOptions)
  return (
    <div className="w-full fixed z-1000000 top-0 left-0 dark:bg-[rgb(10,10,10)]/100 bg-white flex items-center justify-between md:px-20 px-2 py-4 dark:text-white text-black border-b border-b-[rgb(162,162,162)]/20">
