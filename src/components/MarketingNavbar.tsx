...
const MarketingNavbar = async () => {
  ...
  return (
    <div className="w-full fixed z-1000 top-0 left-0 dark:bg-black/30 bg-white/10 flex items-center justify-between px-20 py-4 dark:text-white text-black border-b border-b-muted-foreground">
